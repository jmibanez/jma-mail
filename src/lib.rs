...
/// "Sync complete", "Watch mode active", a download preamble.
/// Tracing logs go to stderr, so the two streams stay separable: a
/// caller can `jma sync >run.log` and still see warnings and errors
/// live on stderr.
///
